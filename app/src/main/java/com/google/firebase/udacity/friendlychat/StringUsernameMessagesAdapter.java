...
public class StringUsernameMessagesAdapter extends ArrayAdapter<String> {

    private List<String> userNameMessages;
    private Context context;

    public StringUsernameMessagesAdapter(Context context, int resource, List<String> userNameMessages) {
